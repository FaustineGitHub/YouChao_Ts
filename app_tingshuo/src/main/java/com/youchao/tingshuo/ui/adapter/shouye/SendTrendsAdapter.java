 ...
 * 发布动态（图片/视频，音频），设置adapter
 */

public class SendTrendsAdapter extends RecyclerView.Adapter<SendTrendsAdapter.ViewHolder>{
    ...
    public SendTrendsAdapter(Context context, onAddPicClickListener onAddPicClickListener) {
