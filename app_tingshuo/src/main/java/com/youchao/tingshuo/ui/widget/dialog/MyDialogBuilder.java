...
/**
 * Created by JinzLin on 2016/8/10.
 * 自定义Dialog
 */
...
public class MyDialogBuilder extends Dialog implements DialogInterface {
    ...
    private Button dialog_btn_left, dialog_btn_right, dialog_btn_all,dialog_btn_left_withdraworder,dialog_btn_right_withdraworder;
...
//        }
    ...
    public void init() {
        ...
        dialog_btn_left_withdraworder = (Button) mDialogView.findViewById(R.id.dialog_btn_left_withdraworder);
        dialog_btn_right_withdraworder = (Button) mDialogView.findViewById(R.id.dialog_btn_right_withdraworder);
    ...
    // 按钮字体颜色
    public MyDialogBuilder setBtn1TextColor(int btn1) {
        dialog_btn_all.setTextColor(btn1);
        return this;
    }
    ...
    //撤单页面的按钮
    public MyDialogBuilder setBtn2_dialog(View.OnClickListener clickLeft, View.OnClickListener clickRight) {
        dialog_btn_all.setVisibility(View.GONE);
        dialog_btn_left_withdraworder.setVisibility(View.VISIBLE);
        dialog_btn_right_withdraworder.setVisibility(View.VISIBLE);
        dialog_btn_left_withdraworder.setOnClickListener(clickLeft);
        dialog_btn_right_withdraworder.setOnClickListener(clickRight);
        return this;
    }
    ...
    public MyDialogBuilder setCustomDateView(int resId) {
       /* customView = View.inflate(context, resId, null);
        ...
        DatePrickerUtil.setDatePickerDividerColor(datePicker);
        mydialog_custompanel.addView(customView);*/
        return this;
    }
    /**===========================================================================================================*/
...
//    }
    ...
    public MyDialogBuilder setSingleChoice(Context context, final String[] datas, int item,
       ...
       listView.setAdapter(new CommonAdapter<String>(context, item, data) {
            @Override
