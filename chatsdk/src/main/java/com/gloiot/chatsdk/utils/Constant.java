...
public class Constant {
    ...
    public static final String CHAT_SERVER_URL = "http://192.168.0.203:9090"; // 测试----小铺


//    public static final String CHAT_SERVER_URL = "http://jiayou.qqjlb.cn:7070"; // 正式----小铺


    // 认证的msg
    public static String RENZHENG_SUCCESS = "认证成功";
    public static String RENZHENG_RANDOMINCORRECT = "随机码不正确";
